...
class ByteArray {
    ...
    readInt64() {
        if (this.validate(8 /* SIZE_OF_INT64 */)) {
            let low = this.data.getUint32(this._position, this.$endian == 0 /* LITTLE_ENDIAN */);
            let high = this.data.getInt32(this._position + 4, this.$endian == 0 /* LITTLE_ENDIAN */);
            this.position += 8 /* SIZE_OF_INT64 */;
    ...
    readUInt64() {
        if (this.validate(8 /* SIZE_OF_UINT64 */)) {
            let low = this.data.getUint32(this._position, this.$endian == 0 /* LITTLE_ENDIAN */);
            let high = this.data.getUint32(this._position + 4, this.$endian == 0 /* LITTLE_ENDIAN */);
            this.position += 8 /* SIZE_OF_UINT64 */;
            return high * 0x100000000 + low;
        }
    }
    /**
    ...
    writeInt64(value) {
        if (value >= 0) {
            ...
            this.data.setUint32(this._position, low, this.$endian == 0 /* LITTLE_ENDIAN */);
            this.data.setInt32(this._position + 4, hi, this.$endian == 0 /* LITTLE_ENDIAN */);
            this.position += 8 /* SIZE_OF_UINT64 */;
        }
    }
    /**
    ...
    writeUInt64(value) {
        this.validateBuffer(8 /* SIZE_OF_UINT64 */);
        this.data.setUint32(this._position, value & 0xFFFFFFFF, this.$endian == 0 /* LITTLE_ENDIAN */);
        this.data.setUint32(this._position + 4, Math.floor(value / 0x100000000) & 0xFFFFFFFF, this.$endian == 0 /* LITTLE_ENDIAN */);
        this.position += 8 /* SIZE_OF_UINT64 */;
    }
    /**
